  ...
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600">
    <div class="bg-white rounded-lg shadow-xl p-8 max-w-md w-full mx-4">
      ...
      <div v-if="!isRegisterMode">
        ...
        <button 
          @click="showGoogleNotAvailable"
          :disabled="true"
          class="w-full bg-gray-400 text-gray-600 font-bold py-3 px-4 rounded-lg mb-4 cursor-not-allowed opacity-75"
        >
          🔍 Googleでログイン（準備中）
        </button>
...
export default {
  ...
  methods: {
    ...
    showGoogleNotAvailable() {
      this.showError('Google認証機能は現在準備中です。通常のメール・パスワードでログインをご利用ください。')
    },

    async loginWithGoogle() {
      // Google認証機能は一時的に無効化されています
      this.showGoogleNotAvailable()
      return
